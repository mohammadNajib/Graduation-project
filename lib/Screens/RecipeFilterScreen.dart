...
class _RecipeFilterScreenState extends State<RecipeFilterScreen> with AutomaticKeepAliveClientMixin {
            ...
            return Scaffold(
              ...
              floatingActionButton: Padding(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    BlocProvider.of<SearchBloc>(context).add(SearchRecipes(price.text, minCalories.text,
                        maxCalories.text, preparationTime, rating.toString(), category == 'الصنف' ? 'null' : category));
                  },
                ),
              ),
